...
class CaCertBundle(BaseModel):
    ...
    file_name: Optional[Global[str]] = Field(default=None, validation_alias="fileName")
    bundle_string: Optional[Global[str]] = Field(default=None, validation_alias="bundle_string")
