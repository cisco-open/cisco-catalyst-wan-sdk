...
class TestDeviceAccessIPv4Converter(unittest.TestCase):
    ...
    def test_acl_ipv4_convert(self):
        ...
        inseq = ins.add_sequence(name=exp_sequence_name, base_action=exp_sequence_base_action)
        ...
        # Act
        outs = cast(Ipv4AclParcel, convert(in_=ins, uuid=uuid4(), context=self.context))
