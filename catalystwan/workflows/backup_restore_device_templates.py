...
def export_device_templates(
    session: ManagerSession, device_template_list: DataSequence[DeviceTemplateInfo], templates_directory: Path
    ...
    Args:
        ...
        device_template_list: A sequence of DeviceTemplateInfo instances to be exported.
...
"""
session = create_manager_session(url="X.X.X.X", port=443, username="admin", password="password")
