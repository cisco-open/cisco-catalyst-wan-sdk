...
from catalystwan.models.common import IpsecCiphersuite
...
class WanInterfaceIpsecTemplateConverter:
    ...
    def create_parcel(self, name: str, description: str, template_values: dict) -> InterfaceIpsecParcel:
        ...
        pre_shared_secret = pre_shared_key.get("pre_shared_secret")
    ...
    def parse_pre_pre_shared_secret(self, data: dict) -> Global[str]:
        pre_shared_secret = (
